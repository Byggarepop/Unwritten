...
public static class MemberTrainer
{
    ...
    public static CoChangeIndex Build(GitTransactionSource source, string repoPath, ConventionSenseConfig config)
    {
    ...
    public static void UpdateIncremental(
        CoChangeIndex index, string repoPath, IReadOnlyList<Transaction> newTransactions, ConventionSenseConfig config)
    {
        IngestAll(index, repoPath, newTransactions, config);
    }

    private static void IngestAll(
        CoChangeIndex index, string repoPath, IReadOnlyList<Transaction> transactions, ConventionSenseConfig config)
    {
